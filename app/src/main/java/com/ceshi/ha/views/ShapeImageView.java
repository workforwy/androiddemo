...
/**
 * Created by WY on 2017/11/1 0001.
 */
public class ShapeImageView extends AppCompatImageView {
    ...
    private String shape_type2;// 形状的类型2
    ...
    private void setAttributes(AttributeSet attrs) {
        ...
        // 得到内边框颜色，否则返回默认颜色
        in_border_color = mArray.getColor(R.styleable.shapeimageview_in_border_color, defColor);
        // 得到外边框颜色，否则返回默认颜色
        out_border_color = mArray.getColor(R.styleable.shapeimageview_out_border_color, defColor);
        // 得到形状的类型
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if ("round".equals(shape_type)) {
            ...
            } else if (in_border_color != defColor && out_border_color == defColor) {// 如果内圆边框颜色不等于默认颜色，则说明该圆有一个边框
