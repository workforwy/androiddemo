package com.ceshi.ha.utils.media;
...
import com.ceshi.ha.utils.log.LogUtils;
...
public class RecorderControl {
    ...
    private static final String TAG = RecorderControl.class.getSimpleName();
    //录音
    ...
    public boolean stopPlaying() {
        ...
        if (mPlayer != null) {
            ...
            LogUtils.i(TAG, "RecorderControl mPlayer.stop()");
            mPlayer.stop();
            mPlayer.release();
            mPlayer = null;
            playState = false;
            ...
            LogUtils.i(TAG, "RecorderControl mPlayer.stop() is null");
            return false;
        }
    }
    //当文件播放结束后调用此方法
    ...
    ////				playState = false;
    ////			}
    //			LogUtils.i(TAG, "RecorderControl 播放结束");
    //			mPlayer.release();
    //			mPlayer = null;
    //		}
    //	};
