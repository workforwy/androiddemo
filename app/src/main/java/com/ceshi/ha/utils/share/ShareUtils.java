package com.ceshi.ha.utils.share;
...
public class ShareUtils {
    ...
    public static void shareFile(Context context, String filePath) {
        ...
        if (context == null || TextUtils.isEmpty(filePath)) {
            Log.e("123", "shareFile context is null or filePath is empty.");
            return;
        }
...
//            }
            ...
            Log.d("123", "shareFile fileType " + fileType);
            Log.d("123", "shareFile uri: " + uri);
