package com.ceshi.ha.utils.image;
...
public class FastBlur {
    ...
    public static Bitmap doBlur(Bitmap sentBitmap, int radius, boolean canReuseInBitmap) {
        ...
        /**
         *这是一个妥协的高斯模糊和方框模糊之间创造更好的寻找模糊比方框模糊，但比我的高斯模糊实现更快7x。
         *我称之为“堆栈模糊”，因为它描述了这个过滤器在内部工作的最佳方式：它在扫描图像时创建了一种移动的颜色堆栈。因此它只需在右边添加一块新的颜色块。
         *栈中取出左边的颜色。堆栈最顶层的其余颜色是加上或减为一个，取决于它们是在堆栈的右边还是在左边。
         *如果在代码中使用此算法，请添加以下行：
         *Mario Klingemann的<< mario@quasimondo.com >堆栈模糊算法
         */
